package com.mahesh.realm.androidrealmdatabase.database;
...
public class SharedPreferencesManager {
    ...
    private SharedPreferencesManager(@NonNull Context context) {
        preferences = context.getSharedPreferences(SharedPrefConstants.PREF_LOGIN_CREDENTIAL, Context.MODE_PRIVATE);
    }
